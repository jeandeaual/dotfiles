...
(use-package org
  ...
  (use-package org-caldav
    ...
    (setq my/inboxes '("~/Dropbox/Notes/Calendar/alexis@z-works.org"
                       "~/Dropbox/Notes/Calendar/alexis.jeandeau@gmail.org"))

    ;; Touch the file if it doesn't exist
    (mapc (lambda (file)
            (unless (file-exists-p "~/Dropbox/Notes/Calendar/alexis@z-works.org")
              (write-region "" nil "~/Dropbox/Notes/Calendar/alexis@z-works.org")))
          my/inboxes)

    (setq org-caldav-calendars
      `((:url google
         :calendar-id "alexis@z-works.co.jp"
         :inbox ,(nth 0 my/inboxes)
         :icalendar-timezone "Asia/Tokyo"
         :caldav-oauth2-client-id "426640116201-jjup7jivl6k38sj2o872qlpr40jpcsg7.apps.googleusercontent.com"
         :caldav-oauth2-client-secret "J9ghHDPJdTDGr0xq8bR9nuGB")
        (:url google
         :calendar-id "alexis.jeandeau@gmail.com"
         :inbox ,(nth 1 my/inboxes)
         :icalendar-timezone "Asia/Tokyo"
         :caldav-oauth2-client-id "59617057862-8blb8bfum4vsdi42rkmfjpipt0l9dhgk.apps.googleusercontent.com"
         :caldav-oauth2-client-secret "L1lFO2GOoKXiJUBHy-qDHTyi"))))
